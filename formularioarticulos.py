...
from tkinter import ttk # Importar ttk para usar el Notebook
from tkinter import messagebox as mb
from tkinter import scrolledtext as st # Importar scrolledtext para el área de texto desplazable
import articulos
...
class FormularioArticulos:
    ...
    def consultar(self):
        ...
        respuesta1=self.articulo1.consulta(datos)
        if len(respuesta1)>0:
            self.descripcion.set(respuesta1[0][0])
            self.precio.set(respuesta1[0][1])
        else:
            self.descripcion.set(self.codigo.get())
            self.precio.set('')
